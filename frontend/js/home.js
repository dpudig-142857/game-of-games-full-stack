...
const allDiceBearOptions = {
    ...
    avatars: avatars.schema.properties,
    avatarsNeutral: avatarsNeutral.schema.properties,
    basic: basic.schema.properties,
    bigEars: bigEars.schema.properties,
    bigEarsNeutral: bigEarsNeutral.schema.properties,
    bigSmile: bigSmile.schema.properties,
    bots: bots.schema.properties,
    botsNeutral: botsNeutral.schema.properties,
